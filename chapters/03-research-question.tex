...
It is also likely some of the keywords may make it to the title of the paper itself.
...
Typically you constraint your topic somehow by adding more specifiers to your questions although occasionally you might even go the other way and make your questions broader to match your research.
It is more likely you will reduce the scope of your topic instead of expanding, though, especially if you are working under tight page constraints.
It is also valuable to consider how many research questions to cover and what kind of angles each of them covers.

\paragraph{How many research questions to choose for a paper}

It is possible to develop a paper around a single research question and this is what I recommend especially for Bachelor level work early on.
For larger works, one option is to have a central question and several smaller ones that support responding to the central one as these questions may help you to craft your research agenda and choose the right research methods for your inquiry.

If you have to work against a tight page constraint, it is entirely possible you may have to leave some questions out of your paper and leave them for later.
Even then, it is a good idea to document open problems at the end of the Conclusion section of the work so it is clear to the reader that you have considered the broader context beyond your paper.
...
\paragraph{How to construct a good research question}

I tend to avoid questions with boolean answers as in "Is vantablack the darkest black color available?" as they tend to polarize research while often being trivial.
Instead, I would go for questions that can produce variety of answers that may even depend on the method and researcher.
Ideally someone else should be able to repeat your research and validate your findings although finding negative results, or refutations, is possible too.

I think the key to discovering good research questions is to do your own research well and map what others have done before you as this gives a good idea of what kind of questions people in your field or niche tend to use in their research.
Likely you will notice some patterns and the same may go for the type of research that is done against the questions.
Sometimes taking the same question but changing the research method somehow may be an option.
It is typical that at Bachelor level students focus on surveys and literature reviews while more involved empirical work is performed for their Masters.
A good researcher is able to use multiple methods and even combine them within the same study to gain unique insights.
Further, good researchers know niches beyond their own and are able to pull ideas from other branches of science to improve the quality of their work.

\paragraph{You know the least about the topic when you should know the most}
...
As you gain experience of your niche, the nature of this problem will change as you have a better awareness of what has been done before and what is to be done.
That said, inexperienced researchers may approach a topic from an unexpected angle or consider a problem that experiences scientists might overlook.
Some niches are simply more interesting than others and it may even be a good strategy to study a topic that is not so crowded although that has benefits of its own at least in terms of availability of source material.

\paragraph{Time spent understanding the topic saves time in the long run}
...
You should write your review in a scientific style with accurate references as this goes for training especially if you have not done a lot of scientific writing before.
It can take a while to get used to scientific style and the more you work in the style, the easier and the more natural it gets.
If you work towards a doctorate, you should consider publishing this early review in a form that you can use as a part of your thesis in one way or another to ground your research as the work is contributing towards your degree in a strong manner if you do this.


% \paragraph{Consider writing a personal literature review to explore the research space}
...
\paragraph{Literature reviews and surveys are the easiest starting point}
...
Due to their nature, surveys are a natural fit for Bachelor level as they allow you to learn much about scientific writing, especially the first time.

\paragraph{Empirical studies are more complex by nature}
...
These studies are expected at Masters level and industry as they provide specific insights into otherwise difficult-to-understand topics.

\paragraph{Preferred research methods depend on your field}
