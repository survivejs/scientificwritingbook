...
\paragraph{Notetaking methods and related tooling}
...
\paragraph{Maintain a research diary}
...
\paragraph{Capture progress to understand open questions}

Although it takes time, it can be worthwhile to document your progress, primarily if you work with mentors.
In this practice familiar to software development, you treat each iteration of your work as a release to highlight what has changed since the previous one.
...
\begin{enumerate}
    ...
    \item Set up initial chapters for the paper so that content can be attached to it. The content chapter naming and amount can still change later on as you understand your topic and narrative better.
    \item Focus on the hardest part of the paper. In practice this often means the research part that addresses the research questions.
    \item After there are initial results, consider what information the reader should know to understand them. Usually there are several concepts and perhaps some historical context that is beneficial to provide. I fill in the background chapters at this point while considering their naming carefully. Alternatively I might integrate some of the background information to introduction and places where it is needed depending on space requirements.
...
For a topic I am already familiar with, I might use a different order and even write the first draft from the beginning to the end before revising.
The amount of revisions tends to vary on the complexity of the topic and the requirements of the publication.
Generally higher quality work tends to require more time and effort as you tend to find places to improve.
As it goes with creative work, at some point you have to decide its good enough, submit, and move onto the next piece.

\paragraph{Leave gaps to fill later}
...
Especially early on this kind of conceptual work helps you to research your topic in greater detail as you understand the nomenclature surrounding it since a part of the work is about knowing what to search for.
Likely you will notice that there are clear clusters of information around certain topics while there is less information available on others.
These kind of observations can be useful for discussion as they help you point out possible research gaps and omissions in science.

\paragraph{Be prepared to rewrite}
...
In the early part of the process it is more important to develop your conceptual understanding and the structure of the work than to produce refined text.
The key point is that you are building up a well reasoned narrative that uses work available by others to position your research relative to work done by others.
...
Another strategy is to include required background information as you go as then the information will be automatically in the right context.
To avoid breaking flow, using footnotes for this type of meta-commentary can be occasionally useful as long as you do not use footnotes too much.
