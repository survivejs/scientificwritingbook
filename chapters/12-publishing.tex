In case you want to make your work available to a larger public, you must consider where to publish.
...
\begin{description}
    ...
    \item[Thesis] captures knowledge on a specific topic, and the scope depends on the educational level, and the same goes for the rigor related to the review. At Bachelor's level, these are considered more about training writing, while at higher levels, more is expected from the results. However, even a Bachelor's work can occasionally provide novel insights into a topic and have value to other researchers. Because of the fact that Bachelor's theses are usually the first publications of their authors, often universities discourage using them as direct sources although exceptions can be made if the quality of the thesis is high enough.
\end{description}

Beyond these, you might publish more casual material, such as blog posts, press releases, newspaper articles, or even books, aimed at the broader public.
By definition, these type of publications have more casual tone and less strict sourcing requirements.
Your own voice tends to come through them in a stronger manner and they are often more opinionated than scientific publications.
This does not mean they are worthless, on the contrary, as more casual publications expose your ideas to people beyond your research bubble and doing this may occasionally lead to unexpected collaborations.
...
\paragraph{Refer to senior colleagues for ideas on where to publish}
...
\paragraph{Consider using search engines to find publishers}
...
Occasionally publishers provide their own journal search and for example IEEE has one for computer science related topics\footnote{\url{https://publication-recommender.ieee.org/home}}.

\paragraph{Take care to avoid predatory publishers}
...
After your first papers become available, you will likely begin to receive emails from predatory journals and the emails often look official.
...
In case you use spamassassin, you can apply rules from \href{https://github.com/eddelbuettel/filter-journal-spam}{filter-journal-spam repository}\footnote{\url{https://github.com/eddelbuettel/filter-journal-spam}} to eliminate most of the spam related to predatory journals.
...
\paragraph{Write with a target audience in mind}

Although scientific papers are written for the scientific community, the papers are reviewed by individual people.
Each conference and journal tends to have its own style and tone and it is worth researching beforehand what kind of papers they have published earlier as this gives you idea of what kind of work they generally accept.
If you are too far apart from style and content, it is possible you will get rejected.
Besides checking content, it is worth investigating who are behind your target publication as looking into their research may help you discover valuable papers to study and potentially integrate into your work.
...
\paragraph{Make your work more broadly available}
...
\paragraph{Getting published can take a while}
...
\paragraph{Show your rough ideas to your advisors}
...
\paragraph{Bring more people on board as the work is stable}
...
\paragraph{Participate in student workshops and seminars}
...
\section{How to deal with review feedback}
...
\paragraph{Especially first submission is unpredictable}
...
\paragraph{How to interpret review feedback}
...
\paragraph{Remember that reviewers are there to help you}
...
\paragraph{How to respond to reviewer comments}
...
To gain further perspective on reviewing and to progress with your academic career, it is possible to get invited to become a reviewer for a publication or a conference.
Some conferences may even require you to peer review another paper or papers for them as a part of the submission process.
...
Especially early on reviewing can be difficult work since you need to judge multiple criteria and consider whether the proposed paper would fit the publication.
For this reason, publishers often have their own supporting material to guide their reviewers so that the process is useful for parties involved.
\href{https://reviewers.acm.org/training-course}{ACM's Peer Review Training Course}\footnote{\url{https://reviewers.acm.org/training-course}} is a good starting point especially for computer science oriented researchers as it contains key information related to performing reviews.

\paragraph{Peer review process}
